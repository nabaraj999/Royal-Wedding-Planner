...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO bookings (bride_name, groom_name, bride_father, bride_mother, groom_father, groom_mother, phone_number, bride_photo, groom_photo, marriage_date, catering_package, decoration_package, card_package, venue_package, total_cost) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    
    $stmt->bind_param("ssssssssssssddd", $bride_name, $groom_name, $bride_father, $bride_mother, $groom_father, $groom_mother, $phone_number, $bride_photo, $groom_photo, $marriage_date, $catering_package, $decoration_package, $card_package, $venue_package, $total_cost);
